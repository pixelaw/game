...
mod update_color_system {
    ...
    use pixelaw::events::ColorUpdated;
    ...
    fn execute(
        ...
        serde::Serde::serialize(
            @ColorUpdated { color: new_color, caller: ctx.origin.into() }, ref values
        );
        emit(ctx, 'ColorUpdated', values.span());
    }
}
...
mod tests {
    ...
    fn test_update_color() {
        ...
        world.execute('update_color_system'.into(), calldata.span());
